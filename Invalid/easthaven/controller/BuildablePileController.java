package org.combinators.solitaire.easthaven.controller;

import org.combinators.solitaire.easthaven.*;
...
public class BuildablePileController extends SolitaireReleasedAdapter {
    ...
    public BuildablePileController(EastHaven theGame, BuildablePileView src) {
        super(theGame);
