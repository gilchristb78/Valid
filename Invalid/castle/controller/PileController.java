package org.combinators.solitaire.castle.controller;

import org.combinators.solitaire.castle.*;
...
public class PileController extends SolitaireReleasedAdapter {
    ...
    public PileController(Castle theGame, PileView src) {
        super(theGame);
