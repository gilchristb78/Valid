package org.combinators.solitaire.scotchpatience.model;
...
public class MoveCardFoundation extends Move {
    ...
    public boolean valid(Solitaire game) {
        return (true && ConstraintHelper.ifCompute(destination.empty(), () -> movingCard.getRank() == Card.ACE, () -> (movingCard.getRank() == (destination.peek().getRank() % 13) + 1 && movingCard.oppositeColor(destination.peek()))));
    }
}
