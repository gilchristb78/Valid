package org.combinators.solitaire.milligancell.controller;
...
public class PileController extends SolitaireReleasedAdapter {
    ...
    protected MilliganCell theGame;
    ...
    public PileController(MilliganCell theGame, PileView src) {
        super(theGame);
    ...
    public void mouseReleased(MouseEvent me) {
        ...
        if (w instanceof CardView) {
            ...
            try {
                ...
                Pile toElement = (Pile) src.getModelElement();
                // Identify the source
                FreeCellElement sourceEntity = (FreeCellElement) sourceWidget.getModelElement();
                // this is the actual move
                Move m = new MoveFreeCellToFoundation(sourceEntity, movingElement, toElement);
                if (m.valid(theGame)) {
                    m.doMove(theGame);
                    theGame.pushMove(m);
                } else {
