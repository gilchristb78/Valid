...
public class MoveColumn extends Move {
    ...
    public boolean valid(Solitaire game) {
        return (true && ((((destination.empty() && movingCards.descending()) && movingCards.alternatingColors()) && movingCards.peek(0).getRank() == Card.KING) || ((movingCards.descending() && movingCards.alternatingColors()) && destination.peek().oppositeColor(movingCards.peek(0)))));
    }
}
