 ...
 */
public class MoveFoundationToFreeCell extends Move {

    protected Stack destination;

    protected Stack source;

    public MoveFoundationToFreeCell(Stack from, Stack to) {
        super();
        this.source = from;
        this.destination = to;
    }
    ...
    public MoveFoundationToFreeCell(Stack from, Card card, Stack to) {
        this(from, to);
