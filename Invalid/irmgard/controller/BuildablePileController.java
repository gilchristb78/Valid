package org.combinators.solitaire.irmgard.controller;

import org.combinators.solitaire.irmgard.*;
...
public class BuildablePileController extends SolitaireReleasedAdapter {
    ...
    public BuildablePileController(Irmgard theGame, BuildablePileView src) {
        super(theGame);
