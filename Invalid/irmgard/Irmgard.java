package org.combinators.solitaire.irmgard;
...
import org.combinators.solitaire.irmgard.controller.*;
import org.combinators.solitaire.irmgard.model.*;
 ...
 */
public class Irmgard extends Solitaire {
    ...
    public static void main(String[] args) {
        final GameWindow gw = Main.generateWindow(new Irmgard(), Deck.OrderBySuit);
    ...
    public BuildablePile[] tableau = new BuildablePile[9];

    public static final String tableauPrefix = "tableau";

    public BuildablePileView[] tableauView = new BuildablePileView[9];
