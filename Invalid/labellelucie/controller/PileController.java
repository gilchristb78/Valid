package org.combinators.solitaire.labellelucie.controller;

import org.combinators.solitaire.labellelucie.*;
...
public class PileController extends SolitaireReleasedAdapter {
    ...
    protected LabelleLucie theGame;
    ...
    public PileController(LabelleLucie theGame, PileView src) {
        super(theGame);
