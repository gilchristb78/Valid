...
import org.combinators.solitaire.gypsy.controller.*;
 ...
 */
public class Gypsy extends Solitaire {
    ...
    public static void main(String[] args) {
        final GameWindow gw = Main.generateWindow(new Gypsy(), Deck.OrderBySuit);
