package org.combinators.solitaire.gypsy.controller;

import org.combinators.solitaire.gypsy.*;
// where move classes are placed.
import org.combinators.solitaire.gypsy.model.*;
...
public class BuildablePileController extends SolitaireReleasedAdapter {
    ...
    public BuildablePileController(Gypsy theGame, BuildablePileView src) {
        super(theGame);
