...
public class MoveColumn extends Move {
    ...
    public boolean valid(Solitaire game) {
        return (true && (((destination.empty() && movingCards.descending()) && movingCards.alternatingColors()) || ((movingCards.descending() && movingCards.alternatingColors()) && destination.peek().sameColor(movingCards.peek(0)))));
    }
}
