package org.combinators.solitaire.superflowergarden;
...
import org.combinators.solitaire.superflowergarden.controller.*;
import org.combinators.solitaire.superflowergarden.model.*;
 ...
 */
public class SuperFlowerGarden extends Solitaire implements SolvableSolitaire {
    ...
    public void initialize() {
        ...
        foundationView[0].setBounds(300, 10, 73, 97);
        addViewWidget(foundationView[0]);
        foundationView[1].setBounds(388, 10, 73, 97);
        addViewWidget(foundationView[1]);
        foundationView[2].setBounds(476, 10, 73, 97);
        addViewWidget(foundationView[2]);
        foundationView[3].setBounds(564, 10, 73, 97);
    ...
    public static void main(String[] args) {
        final GameWindow gw = Main.generateWindow(new SuperFlowerGarden(), Deck.OrderBySuit);
