package org.combinators.solitaire.superflowergarden.controller;

import org.combinators.solitaire.superflowergarden.*;
...
public class PileController extends SolitaireReleasedAdapter {
    ...
    protected SuperFlowerGarden theGame;
    ...
    public PileController(SuperFlowerGarden theGame, PileView src) {
        super(theGame);
