package org.combinators.solitaire.spiderwort;
...
import org.combinators.solitaire.spiderwort.controller.*;
import org.combinators.solitaire.spiderwort.model.*;
 ...
 */
public class Spiderwort extends Solitaire {
    ...
    public static void main(String[] args) {
        final GameWindow gw = Main.generateWindow(new Spiderwort(), Deck.OrderBySuit);
    ...
    public BuildablePile[] tableau = new BuildablePile[13];

    public static final String tableauPrefix = "tableau";

    public BuildablePileView[] tableauView = new BuildablePileView[13];

    public Pile[] foundation = new Pile[12];

    public static final String foundationPrefix = "foundation";

    public PileView[] foundationView = new PileView[12];
    ...
    public Dimension getPreferredSize() {
        ...
        return new Dimension(1334, 1461);
    }
}
