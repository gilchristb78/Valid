package org.combinators.solitaire.castles_in_spain.controller;

import org.combinators.solitaire.castles_in_spain.*;
// where move classes are placed.
import org.combinators.solitaire.castles_in_spain.model.*;
...
public class PileController extends SolitaireReleasedAdapter {
    ...
    protected Castles_In_Spain theGame;
    ...
    public PileController(Castles_In_Spain theGame, PileView src) {
        super(theGame);
