...
public class ScotchPatienceTestCases {
    ...
    public void testMoveCard1() {
        // Testing TableauToNextTableauIgnoreSuit$
        ...
        Card movingCard = new Card(Card.TWO, Card.HEARTS);
    ...
    public void testMoveCardFoundation2() {
        // Testing TableauToNextFoundationOppositeColor$
        String type = "SingleCard$";
        // this is where test set-up must go.
        game.tableau[1].removeAll();
