...
public class MoveCard extends Move {
    ...
    public boolean valid(Solitaire game) {
        return (true && ConstraintHelper.ifCompute(destination.empty(), () -> !(movingCard.getRank() == Card.ACE), () -> (destination.peek().getRank() == (movingCard.getRank() % 13) + 1 && destination.peek().oppositeColor(movingCard))));
    }
}
