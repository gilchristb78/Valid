package org.combinators.solitaire.curdsandwhey.controller;

import org.combinators.solitaire.curdsandwhey.*;
...
public class PileController extends SolitaireReleasedAdapter {
    ...
    protected CurdsAndWhey theGame;
    ...
    public PileController(CurdsAndWhey theGame, PileView src) {
        super(theGame);
