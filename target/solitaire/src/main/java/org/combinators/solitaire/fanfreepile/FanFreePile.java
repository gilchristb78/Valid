...
import org.combinators.solitaire.fanfreepile.controller.*;
 ...
 */
public class FanFreePile extends Solitaire implements SolvableSolitaire {
    ...
    public void initialize() {
        ...
        for (int j = 0; j < 2; j++) {
            reserve[j] = new FreePile(reservePrefix + (j + 1));
            addModelElement(reserve[j]);
            reserveView[j] = new FreePileView(reserve[j]);
        }
        ...
        tableauView[6].setBounds(100, 400, 73, 194);
        addViewWidget(tableauView[6]);
        tableauView[7].setBounds(203, 400, 73, 194);
        addViewWidget(tableauView[7]);
        tableauView[8].setBounds(306, 400, 73, 194);
        addViewWidget(tableauView[8]);
        tableauView[9].setBounds(409, 400, 73, 194);
        addViewWidget(tableauView[9]);
        tableauView[10].setBounds(512, 400, 73, 194);
        addViewWidget(tableauView[10]);
        tableauView[11].setBounds(615, 400, 73, 194);
        addViewWidget(tableauView[11]);
        tableauView[12].setBounds(100, 600, 73, 194);
        addViewWidget(tableauView[12]);
        tableauView[13].setBounds(203, 600, 73, 194);
        addViewWidget(tableauView[13]);
        tableauView[14].setBounds(306, 600, 73, 194);
        addViewWidget(tableauView[14]);
        tableauView[15].setBounds(409, 600, 73, 194);
        addViewWidget(tableauView[15]);
        tableauView[16].setBounds(512, 600, 73, 194);
        addViewWidget(tableauView[16]);
        tableauView[17].setBounds(615, 600, 73, 194);
        ...
        reserveView[0].setBounds(800, 250, 73, 97);
        addViewWidget(reserveView[0]);
        reserveView[1].setBounds(800, 362, 73, 97);
        ...
        for (int j = 0; j < 2; j++) {
            ...
            reserveView[j].setMouseAdapter(new FreePileController(this, reserveView[j]));
        }
        for (int i = 0; i < 1; i++) {
            Card c = deck.get();
    ...
    public static void main(String[] args) {
        final GameWindow gw = Main.generateWindow(new FanFreePile(), Deck.OrderBySuit);
    ...
    public Column[] tableau = new Column[18];

    public static final String tableauPrefix = "tableau";

    public ColumnView[] tableauView = new ColumnView[18];
    ...
    public FreePile[] reserve = new FreePile[2];

    public static final String reservePrefix = "reserve";

    public FreePileView[] reserveView = new FreePileView[2];
