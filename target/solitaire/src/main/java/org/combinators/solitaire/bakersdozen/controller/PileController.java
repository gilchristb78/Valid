package org.combinators.solitaire.bakersdozen.controller;

import org.combinators.solitaire.bakersdozen.*;
// where move classes are placed.
import org.combinators.solitaire.bakersdozen.model.*;
...
public class PileController extends SolitaireReleasedAdapter {
    ...
    public PileController(Bakersdozen theGame, PileView src) {
        super(theGame);
