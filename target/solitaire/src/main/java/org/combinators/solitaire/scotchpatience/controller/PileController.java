package org.combinators.solitaire.scotchpatience.controller;

import org.combinators.solitaire.scotchpatience.*;
...
public class PileController extends SolitaireReleasedAdapter {
    ...
    protected ScotchPatience theGame;
    ...
    public PileController(ScotchPatience theGame, PileView src) {
        super(theGame);
