...
trait PythonSpanishPatienceT extends SolitaireSolution {
  lazy val repository = new SpanishPatienceDomain(solitaire) with controllers {}
  import repository._
...
object PythonSpanishPatienceMain extends DefaultMain with PythonSpanishPatienceT {
  override lazy val solitaire = org.combinators.solitaire.spanish_patience.spanish_patience
}
