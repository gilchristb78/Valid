...
trait PythonNarcoticT extends SolitaireSolution {

  lazy val repository = new NarcoticDomain(solitaire) with controllers {}
  import repository._
...
object PythonNarcoticMain extends DefaultMain with PythonNarcoticT {
  override lazy val solitaire = org.combinators.solitaire.narcotic.narcotic
}
