...
/** Defines Gypsy's controllers and their behaviors.
  *
...
trait controllers extends shared.Controller with GameTemplate with WinningLogic  with shared.Moves with generic.JavaCodeIdioms {
  ...
  ReflectedRepository[G] = {
    ...
    println (">>> Gypsy Controller dynamic combinators.")
  ...
  /**
    * Same as Klondike, Gypsy has two kinds of press moves (ones that act, and ones that lead to drags).
