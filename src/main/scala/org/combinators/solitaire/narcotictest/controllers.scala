...
trait controllers extends shared.Controller with GameTemplate with WinningLogic with shared.Moves with generic.JavaCodeIdioms {
  ...
  override def init[G <: SolitaireDomain](narcotictest: ReflectedRepository[G], s: Solitaire):
  ReflectedRepository[G] = {
    var updated = super.init(narcotictest, s)
    println(">>> Narcotictest Controller dynamic combinators.")
