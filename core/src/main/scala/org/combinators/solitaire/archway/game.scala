...
//      val acesFoundation = solitaire.containers.get(SolitaireContainerTypes.Foundation)
//      val kingsFoundation = solitaire.containers.get(StalactitesContainerTypes.Foundation)
//
