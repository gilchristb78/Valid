package org.combinators.solitaire.mrsmop.controller;

import org.combinators.solitaire.mrsmop.*;
...
public class PileController extends SolitaireReleasedAdapter {
    ...
    public PileController(MrsMop theGame, PileView src) {
        super(theGame);
