package org.combinators.solitaire.scorpion.controller;

import org.combinators.solitaire.scorpion.*;
...
public class PileController extends SolitaireReleasedAdapter {
    ...
    public PileController(Scorpion theGame, PileView src) {
        super(theGame);
