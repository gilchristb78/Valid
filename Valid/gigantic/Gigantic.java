package org.combinators.solitaire.gigantic;
...
import org.combinators.solitaire.gigantic.controller.*;
import org.combinators.solitaire.gigantic.model.*;
 ...
 */
public class Gigantic extends Solitaire {
    ...
    public void initialize() {
        ...
        tableauView[13].setBounds(1159, 200, 73, 1261);
        addViewWidget(tableauView[13]);
        tableauView[14].setBounds(1247, 200, 73, 1261);
        ...
        foundationView[4].setBounds(645, 20, 73, 97);
        addViewWidget(foundationView[4]);
        foundationView[5].setBounds(733, 20, 73, 97);
        addViewWidget(foundationView[5]);
        foundationView[6].setBounds(821, 20, 73, 97);
        addViewWidget(foundationView[6]);
        foundationView[7].setBounds(909, 20, 73, 97);
        addViewWidget(foundationView[7]);
        foundationView[8].setBounds(997, 20, 73, 97);
        addViewWidget(foundationView[8]);
        foundationView[9].setBounds(1085, 20, 73, 97);
        addViewWidget(foundationView[9]);
        foundationView[10].setBounds(1173, 20, 73, 97);
        addViewWidget(foundationView[10]);
        foundationView[11].setBounds(1261, 20, 73, 97);
        addViewWidget(foundationView[11]);
        foundationView[12].setBounds(1349, 20, 73, 97);
        addViewWidget(foundationView[12]);
        foundationView[13].setBounds(1437, 20, 73, 97);
        addViewWidget(foundationView[13]);
        foundationView[14].setBounds(1525, 20, 73, 97);
        addViewWidget(foundationView[14]);
        foundationView[15].setBounds(1613, 20, 73, 97);
        addViewWidget(foundationView[15]);
    ...
    public static void main(String[] args) {
        final GameWindow gw = Main.generateWindow(new Gigantic(), Deck.OrderBySuit);
    ...
    public BuildablePile[] tableau = new BuildablePile[15];

    public static final String tableauPrefix = "tableau";

    public BuildablePileView[] tableauView = new BuildablePileView[15];

    public Pile[] foundation = new Pile[16];

    public static final String foundationPrefix = "foundation";

    public PileView[] foundationView = new PileView[16];
    ...
    public Dimension getPreferredSize() {
        ...
        return new Dimension(1686, 1461);
    }
}
