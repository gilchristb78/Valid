package org.combinators.solitaire.gigantic.controller;

import org.combinators.solitaire.gigantic.*;
...
public class PileController extends SolitaireReleasedAdapter {
    ...
    public PileController(Gigantic theGame, PileView src) {
        super(theGame);
