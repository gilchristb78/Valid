package org.combinators.solitaire.napoleon.controller;

import org.combinators.solitaire.napoleon.*;
...
public class ColumnController extends SolitaireReleasedAdapter {
    ...
    public ColumnController(Napoleon theGame, ColumnView src) {
        super(theGame);
    ...
    public void mouseReleased(MouseEvent me) {
        ...
        if (w instanceof CardView) {
            ...
            try {
                ...
                Move m = new MoveTableau(sourceEntity, movingElement, toElement);
                if (m.valid(theGame)) {
                    m.doMove(theGame);
                    theGame.pushMove(m);
                } else {
        ...
        if (w instanceof CardView) {
            ...
            try {
                ...
                // this is the actual move
                Move m = new MoveWasteToTableau(sourceEntity, movingElement, toElement);
                if (m.valid(theGame)) {
                    m.doMove(theGame);
                    theGame.pushMove(m);
                } else {
