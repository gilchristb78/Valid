package org.combinators.solitaire.delta.controller;

import org.combinators.solitaire.delta.*;
...
public class ColumnController extends SolitaireReleasedAdapter {
    ...
    public ColumnController(delta theGame, ColumnView src) {
        super(theGame);
    ...
    public void mouseReleased(MouseEvent me) {
        ...
        if (w instanceof CardView) {
            ...
            try {
                ...
                Move m = new Tableau(sourceEntity, movingElement, toElement);
                if (m.valid(theGame)) {
                    m.doMove(theGame);
                    theGame.pushMove(m);
                } else {
