package org.combinators.solitaire.castles_in_spain.model;
...
public class MoveCardFoundation extends Move {
    ...
    public boolean valid(Solitaire game) {
        return (true && ConstraintHelper.ifCompute(destination.empty(), () -> movingCard.getRank() == Card.ACE, () -> (((destination.empty() && movingCard.getRank() == Card.ACE) || destination.peek().getSuit() == movingCard.getSuit()) || movingCard.getRank() == destination.peek().getRank() + 1)));
    }
}
