package org.combinators.solitaire.openscorpion;
...
import org.combinators.solitaire.openscorpion.controller.*;
import org.combinators.solitaire.openscorpion.model.*;
 ...
 */
public class OpenScorpion extends Solitaire {
    ...
    public static void main(String[] args) {
        final GameWindow gw = Main.generateWindow(new OpenScorpion(), Deck.OrderBySuit);
    ...
    public BuildablePile[] tableau = new BuildablePile[7];

    public static final String tableauPrefix = "tableau";

    public BuildablePileView[] tableauView = new BuildablePileView[7];
