...
public class MoveColumn extends Move {
    ...
    public boolean valid(Solitaire game) {
        return (true && ConstraintHelper.ifCompute(movingCards.peek(0).getRank() == Card.KING, () -> destination.empty(), () -> (destination.peek().getSuit() == movingCards.peek(0).getSuit() && destination.peek().getRank() == movingCards.peek(0).getRank() + 1)));
    }
}
