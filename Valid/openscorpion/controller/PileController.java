package org.combinators.solitaire.openscorpion.controller;

import org.combinators.solitaire.openscorpion.*;
...
public class PileController extends SolitaireReleasedAdapter {
    ...
    protected OpenScorpion theGame;
    ...
    public PileController(OpenScorpion theGame, PileView src) {
        super(theGame);
