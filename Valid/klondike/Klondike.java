...
import org.combinators.solitaire.klondike.controller.*;
import org.combinators.solitaire.klondike.model.*;
...
public class Klondike extends Solitaire {
    ...
    public static void main(String[] args) {
        final GameWindow gw = Main.generateWindow(new Klondike(), Deck.OrderBySuit);
