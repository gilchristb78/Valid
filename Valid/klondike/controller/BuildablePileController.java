package org.combinators.solitaire.klondike.controller;

import org.combinators.solitaire.klondike.*;
...
public class BuildablePileController extends SolitaireReleasedAdapter {
    ...
    public BuildablePileController(Klondike theGame, BuildablePileView src) {
        super(theGame);
