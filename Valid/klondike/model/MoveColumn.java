...
public class MoveColumn extends Move {
    ...
    public boolean valid(Solitaire game) {
        return (true && (((destination.empty() && movingCards.descending()) && movingCards.alternatingColors()) || (((movingCards.descending() && movingCards.alternatingColors()) && destination.peek().getRank() == (movingCards.peek(0).getRank() % 13) + 1) && destination.peek().oppositeColor(movingCards.peek(0)))));
    }
}
