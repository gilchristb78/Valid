package org.combinators.solitaire.faneasy.controller;

import org.combinators.solitaire.faneasy.*;
...
public class PileController extends SolitaireReleasedAdapter {
    ...
    public PileController(FanEasy theGame, PileView src) {
        super(theGame);
