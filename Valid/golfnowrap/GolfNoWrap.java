package org.combinators.solitaire.golfnowrap;
...
import org.combinators.solitaire.golfnowrap.controller.*;
import org.combinators.solitaire.golfnowrap.model.*;
 ...
 */
public class GolfNoWrap extends Solitaire {
    ...
    public static void main(String[] args) {
        final GameWindow gw = Main.generateWindow(new GolfNoWrap(), Deck.OrderBySuit);
    ...
    public Column[] tableau = new Column[7];

    public static final String tableauPrefix = "tableau";

    public ColumnView[] tableauView = new ColumnView[7];
