package org.combinators.solitaire.fanfreepile.controller;

import org.combinators.solitaire.fanfreepile.*;
...
public class FreePileController extends SolitaireReleasedAdapter {

    protected FanFreePile theGame;

    /**
     * The View being controlled
     */
    protected FreePileView src;

    public FreePileController(FanFreePile theGame, FreePileView src) {
        super(theGame);
    ...
    public void mousePressed(MouseEvent me) {
        ...
        me_ignore = false;
        // Return in the case that the widget clicked on is empty
        FreePile srcElement = (FreePile) src.getModelElement();
    ...
    public void mouseReleased(MouseEvent me) {
        ...
        if (w instanceof CardView) {
            ...
            try {
                ...
                FreePile toElement = (FreePile) src.getModelElement();
                // Identify the source
        ...
        if (w instanceof CardView) {
            ...
            try {
                ...
                FreePile toElement = (FreePile) src.getModelElement();
                // Identify the source
                FreePile sourceEntity = (FreePile) sourceWidget.getModelElement();
                // this is the actual move
