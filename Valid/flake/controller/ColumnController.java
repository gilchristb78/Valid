package org.combinators.solitaire.flake.controller;

import org.combinators.solitaire.flake.*;
// where move classes are placed.
import org.combinators.solitaire.flake.model.*;
...
public class ColumnController extends SolitaireReleasedAdapter {
    ...
    public ColumnController(Flake theGame, ColumnView src) {
        super(theGame);
    ...
    public void mouseReleased(MouseEvent me) {
        ...
        if (w instanceof CardView) {
            ...
            try {
                ...
                Move m = new MoveTableauToTableau(sourceEntity, movingElement, toElement);
                if (m.valid(theGame)) {
                    m.doMove(theGame);
                    theGame.pushMove(m);
                } else {
