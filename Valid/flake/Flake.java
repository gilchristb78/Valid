package org.combinators.solitaire.flake;
...
import org.combinators.solitaire.flake.controller.*;
 ...
 */
public class Flake extends Solitaire {
    ...
    public static void main(String[] args) {
        final GameWindow gw = Main.generateWindow(new Flake(), Deck.OrderBySuit);
