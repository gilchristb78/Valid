...
public class MoveCard extends Move {
    ...
    public boolean valid(Solitaire game) {
        return (true && ConstraintHelper.ifCompute(destination.empty(), () -> movingCard.getRank() == Card.KING, () -> ((destination.peek().getRank() == (movingCard.getRank() % 13) + 1 || movingCard.getRank() == (destination.peek().getRank() % 13) + 1) && ConstraintHelper.maxSizeExceeded(movingCard, destination, 3))));
    }
}
