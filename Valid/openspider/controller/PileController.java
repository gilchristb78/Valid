package org.combinators.solitaire.openspider.controller;

import org.combinators.solitaire.openspider.*;
...
public class PileController extends SolitaireReleasedAdapter {
    ...
    public PileController(OpenSpider theGame, PileView src) {
        super(theGame);
