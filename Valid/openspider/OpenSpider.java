package org.combinators.solitaire.openspider;
...
import org.combinators.solitaire.openspider.controller.*;
import org.combinators.solitaire.openspider.model.*;
 ...
 */
public class OpenSpider extends Solitaire {
    ...
    public static void main(String[] args) {
        final GameWindow gw = Main.generateWindow(new OpenSpider(), Deck.OrderBySuit);
    ...
    public BuildablePile[] tableau = new BuildablePile[10];

    public static final String tableauPrefix = "tableau";

    public BuildablePileView[] tableauView = new BuildablePileView[10];
