...
public class MoveColumn extends Move {
    ...
    public boolean valid(Solitaire game) {
        return (true && ((movingCards.descending() && ((org.combinators.solitaire.openspider.OpenSpider) game).allSameSuit(movingCards)) && (destination.empty() || destination.peek().getRank() == movingCards.peek(0).getRank() + 1)));
    }
}
