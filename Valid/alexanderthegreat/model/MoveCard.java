package org.combinators.solitaire.alexanderthegreat.model;
...
public class MoveCard extends Move {
    ...
    public boolean valid(Solitaire game) {
        return (true && ConstraintHelper.ifCompute(destination.empty(), () -> movingCard.getRank() == Card.KING, () -> (destination.peek().getRank() == (movingCard.getRank() % 13) + 1 && movingCard.getSuit() == destination.peek().getSuit())));
    }
}
