...
import org.combinators.solitaire.alexanderthegreat.controller.*;
import org.combinators.solitaire.alexanderthegreat.model.*;
 ...
 */
public class AlexanderTheGreat extends Solitaire implements SolvableSolitaire {
    ...
    public void initialize() {
        ...
        int ch = ci.getHeight();
        for (int j = 0; j < 18; j++) {
            tableau[j] = new AlexColumn(tableauPrefix + (j + 1));
            addModelElement(tableau[j]);
            tableauView[j] = new AlexColumnView(tableau[j]);
        }
        for (int j = 0; j < 4; j++) {
        ...
        for (int j = 0; j < 18; j++) {
            ...
            tableauView[j].setMouseAdapter(new AlexColumnController(this, tableauView[j]));
        }
        for (int j = 0; j < 4; j++) {
    ...
    public static void main(String[] args) {
        final GameWindow gw = Main.generateWindow(new AlexanderTheGreat(), Deck.OrderBySuit);
    ...
    public AlexColumn[] tableau = new AlexColumn[18];

    public static final String tableauPrefix = "tableau";

    public AlexColumnView[] tableauView = new AlexColumnView[18];
