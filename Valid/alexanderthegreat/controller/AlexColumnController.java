package org.combinators.solitaire.alexanderthegreat.controller;

import org.combinators.solitaire.alexanderthegreat.*;
...
public class AlexColumnController extends SolitaireReleasedAdapter {

    protected AlexanderTheGreat theGame;

    /**
     * The View being controlled
     */
    protected AlexColumnView src;

    public AlexColumnController(AlexanderTheGreat theGame, AlexColumnView src) {
        super(theGame);
    ...
    public void mousePressed(MouseEvent me) {
        ...
        me_ignore = false;
        // Return in the case that the widget clicked on is empty
        AlexColumn srcElement = (AlexColumn) src.getModelElement();
    ...
    public void mouseReleased(MouseEvent me) {
        ...
        if (w instanceof CardView) {
            ...
            try {
                ...
                AlexColumn toElement = (AlexColumn) src.getModelElement();
                // Identify the source
                AlexColumn sourceEntity = (AlexColumn) sourceWidget.getModelElement();
