package org.combinators.solitaire.spanish_patience.controller;

import org.combinators.solitaire.spanish_patience.*;
...
public class PileController extends SolitaireReleasedAdapter {
    ...
    protected Spanish_Patience theGame;
    ...
    public PileController(Spanish_Patience theGame, PileView src) {
        super(theGame);
