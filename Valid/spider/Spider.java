...
import org.combinators.solitaire.spider.controller.*;
import org.combinators.solitaire.spider.model.*;
...
public class Spider extends Solitaire {
    ...
    public static void main(String[] args) {
        final GameWindow gw = Main.generateWindow(new Spider(), Deck.OrderBySuit);
