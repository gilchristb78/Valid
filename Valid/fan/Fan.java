...
import org.combinators.solitaire.fan.controller.*;
 ...
 */
public class Fan extends Solitaire implements SolvableSolitaire {
    ...
    public static void main(String[] args) {
        final GameWindow gw = Main.generateWindow(new Fan(), Deck.OrderBySuit);
