package org.combinators.solitaire.simplesimon.model;
...
public class MoveCardFoundation extends Move {
    ...
    public boolean valid(Solitaire game) {
        return (true && (destination.empty() && ((movingCards.descending() && ((org.combinators.solitaire.simplesimon.Simplesimon) game).allSameSuit(movingCards)) && (movingCards.peek().getRank() == Card.ACE && movingCards.peek(0).getRank() == Card.KING))));
    }
}
