package org.combinators.solitaire.simplesimon.controller;

import org.combinators.solitaire.simplesimon.*;
// where move classes are placed.
import org.combinators.solitaire.simplesimon.model.*;
...
public class PileController extends SolitaireReleasedAdapter {
    ...
    public PileController(Simplesimon theGame, PileView src) {
        super(theGame);
