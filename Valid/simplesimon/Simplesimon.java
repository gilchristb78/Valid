...
import org.combinators.solitaire.simplesimon.controller.*;
 ...
 */
public class Simplesimon extends Solitaire {
    ...
    public static void main(String[] args) {
        final GameWindow gw = Main.generateWindow(new Simplesimon(), Deck.OrderBySuit);
