package org.combinators.solitaire.spiderette;
...
import org.combinators.solitaire.spiderette.controller.*;
...
public class Spiderette extends Solitaire {
    ...
    public static void main(String[] args) {
        final GameWindow gw = Main.generateWindow(new Spiderette(), Deck.OrderBySuit);
