package org.combinators.solitaire.spiderette.controller;

import org.combinators.solitaire.spiderette.*;
// where move classes are placed.
import org.combinators.solitaire.spiderette.model.*;
...
public class PileController extends SolitaireReleasedAdapter {
    ...
    public PileController(Spiderette theGame, PileView src) {
        super(theGame);
