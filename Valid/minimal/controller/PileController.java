package org.combinators.solitaire.minimal.controller;

import org.combinators.solitaire.minimal.*;
...
public class PileController extends SolitaireReleasedAdapter {
    ...
    public PileController(Minimal theGame, PileView src) {
        super(theGame);
