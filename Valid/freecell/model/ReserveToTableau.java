...
public class ReserveToTableau extends Move {
    ...
    public boolean valid(Solitaire game) {
        return (true && ConstraintHelper.ifCompute(destination.empty(), () -> true, () -> (destination.peek().getRank() == (movingCard.getRank() % 13) + 1 && movingCard.oppositeColor(destination.peek()))));
    }
}
