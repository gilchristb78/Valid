 ...
 * DraggingCard
 */
public class PotentialMoveColumn extends MoveColumn {

    /**
     * Destination.
     */
    public PotentialMoveColumn(Stack from, Stack to) {
        super(from, to);
        // was numInColumn
        numCards = 1;
    }

    public PotentialMoveColumn(Stack from, Stack to, int num) {
        super(from, to);
        numCards = num;
    }
