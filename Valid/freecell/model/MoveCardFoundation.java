...
public class MoveCardFoundation extends Move {
    ...
    public boolean valid(Solitaire game) {
        return (true && (movingCards.count() == 1 && ConstraintHelper.ifCompute(destination.empty(), () -> movingCards.peek(0).getRank() == Card.ACE, () -> (movingCards.peek(0).getRank() == (destination.peek().getRank() % 13) + 1 && movingCards.peek(0).getSuit() == destination.peek().getSuit()))));
    }
}
