 ...
 */
public class TableauToKingsFoundation extends Move {

    protected Stack destination;

    protected Stack source;

    public TableauToKingsFoundation(Stack from, Stack to) {
        super();
        this.source = from;
        this.destination = to;
    }
    ...
    public TableauToKingsFoundation(Stack from, Card card, Stack to) {
        this(from, to);
