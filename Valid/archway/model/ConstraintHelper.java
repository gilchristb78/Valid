...
public class ConstraintHelper {
    ...
    public static Stack[] kingsdownfoundation(Solitaire game) {
        return getVariation(game).kingsdownfoundation;
    }

    /**
     * Helper to be able to retrieve variation specific solitaire without external cast.
     */
    public static org.combinators.solitaire.archway.Archway getVariation(Solitaire game) {
        return (org.combinators.solitaire.archway.Archway) game;
    }
}
