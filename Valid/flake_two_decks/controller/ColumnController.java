package org.combinators.solitaire.flake_two_decks.controller;

import org.combinators.solitaire.flake_two_decks.*;
...
public class ColumnController extends SolitaireReleasedAdapter {
    ...
    protected Flake_two_decks theGame;
    ...
    public ColumnController(Flake_two_decks theGame, ColumnView src) {
        super(theGame);
