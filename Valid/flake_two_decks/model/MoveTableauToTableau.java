 ...
 */
public class MoveTableauToTableau extends Move {

    protected Stack destination;

    protected Stack source;

    public MoveTableauToTableau(Stack from, Stack to) {
        super();
        this.source = from;
        this.destination = to;
    }
    ...
    public MoveTableauToTableau(Stack from, Card card, Stack to) {
        this(from, to);
