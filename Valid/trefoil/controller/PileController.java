package org.combinators.solitaire.trefoil.controller;

import org.combinators.solitaire.trefoil.*;
...
public class PileController extends SolitaireReleasedAdapter {
    ...
    public PileController(Trefoil theGame, PileView src) {
        super(theGame);
