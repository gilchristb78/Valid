package org.combinators.solitaire.trefoil;
...
import org.combinators.solitaire.trefoil.controller.*;
import org.combinators.solitaire.trefoil.model.*;
 ...
 */
public class Trefoil extends Solitaire implements SolvableSolitaire {
    ...
    public static void main(String[] args) {
        final GameWindow gw = Main.generateWindow(new Trefoil(), Deck.OrderBySuit);
    ...
    public Column[] tableau = new Column[16];

    public static final String tableauPrefix = "tableau";

    public ColumnView[] tableauView = new ColumnView[16];
